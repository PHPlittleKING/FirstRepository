		...
		<div class="layui-header header">
			<div class="layui-main">
			    ...
			    <div class="weather" pc>
					...
					<script>(function(T,h,i,n,k,P,a,g,e){g=function(){P=h.createElement(i);a=h.getElementsByTagName(i)[0];P.src=k;P.charset="utf-8";P.async=1;a.parentNode.insertBefore(P,a)};T["ThinkPageWeatherWidgetObject"]=n;T[n]||(T[n]=function(){(T[n].q=T[n].q||[]).push(arguments)});T[n].l=+new Date();if(T.attachEvent){T.attachEvent("onload",g)}else{T.addEventListener("load",g,false)}}(window,document,"script","tpwidget","js/widget.js"))</script>
			    ...
			    <ul class="layui-nav top_menu">
			    	...
			    	<li class="layui-nav-item" mobile>
			    		<a href="<?php echo U('Login/login');?>" class="signOut"><i class="iconfont icon-loginout"></i>退出</a>
			    	</li>
					...
					<li class="layui-nav-item" pc>
						...
						<dl class="layui-nav-child">
							...
							<dd><a href="<?php echo U('Login/login');?>" class="signOut"><i class="iconfont icon-loginout"></i><cite>退出</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
