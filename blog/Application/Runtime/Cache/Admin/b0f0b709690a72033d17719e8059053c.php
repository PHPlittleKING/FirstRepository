...
<head>
	...
	<link rel="stylesheet" href="css/font_tnyc.css" media="all" />
	<link rel="stylesheet" href="css/main.css" media="all" />
</head>
<body class="childrenBody">
	<div class="panel_box row">
		<div class="panel col">
			<a href="javascript:;" data-url="<?php echo U('Message/show');?>">
		...
		<div class="panel col">
			<a href="javascript:;" data-url="<?php echo U('Admin/add');?>">
		...
		<div class="panel col">
			<a href="javascript:;" data-url="<?php echo U('Admin/show');?>">
		...
		<div class="panel col max_panel">
			<a href="javascript:;" data-url="<?php echo U('Article/show');?>">
		...
		<div class="sysNotice col">
			...
			<table class="layui-table">
				...
				<tbody>
					...
					<tr>
						<td>开发作者</td>
						<td class="author">大娱乐家</td>
					</tr>
					<tr>
						<td>网站首页</td>
						<td class="homePage">http://www.blog.com/admin.php</td>
					</tr>
					<tr>
						<td>服务器环境</td>
						<td class="server">WAMP</td>
					</tr>
					<tr>
						<td>数据库版本</td>
